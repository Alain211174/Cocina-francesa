...
<body>
    ...
    <div class="contenedor-sesion">
        <div class="tarjeta-sesion">
            ...
            <form action="procesar_login.php" method="POST" class="formulario-sesion">
                ...
                <button type="submit" class="boton-login-form" name="login" value="login">Iniciar Sesión</button>
            </form>
            
            <p class="enlace-registro">¿No tienes una cuenta? <a href="registro.php">Regístrate</a></p>
